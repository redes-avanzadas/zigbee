...
ZigBee esta bien posicionado en el área de sensores inalámbricos y control de redes pero existen otras soluciones inalámbricas que al igual que ZigBee utilizan el protocolo 82.15.4:

\begin{itemize}
  \item \textbf{Wirless USB:} es una tecnología emergente de dispositivos operados por batería. Es una tecnología poco costosa, genial para las baterías pero no funciona bien en gran escala y noo provee seguridad. Esta basada en Ultra Wideband (UWB) utilizada mayormente en baterías de dispositivos periféricos para PC.
  \\
...
\bibitem{bombal}
D.~Gislason. \emph{Zigbee Wirless Networking}. \hskip 1em plus 0.5em minus 0.4em\relax Elsevier. ISBN: 978-0-7506-85979. 2008.
